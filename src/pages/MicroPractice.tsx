...
const MicroPractice = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo
        title="AP Microeconomics Practice — MCQs & FRQs"
        description="Practice AP Microeconomics with randomized multiple choice questions and free response prompts, complete with explanations and answer reveals."
        path="/micro/practice"
      />
